...
public class CreationContact {
  ...
  public void testCreationContact() throws Exception {
    driver.get("http://localhost:8443/addressbook/index.php");
    ...
    driver.findElement(By.name("nickname")).sendKeys("1");
    ...
    driver.findElement(By.name("work")).sendKeys("5");
    driver.findElement(By.name("fax")).click();
    driver.findElement(By.name("fax")).clear();
    driver.findElement(By.name("fax")).sendKeys("6");
    driver.findElement(By.name("email")).click();
    driver.findElement(By.name("email")).clear();
    driver.findElement(By.name("email")).sendKeys("7");
    driver.findElement(By.name("email2")).click();
    driver.findElement(By.name("email2")).clear();
    driver.findElement(By.name("email2")).sendKeys("8");
    driver.findElement(By.name("email3")).click();
    driver.findElement(By.name("email3")).clear();
    driver.findElement(By.name("email3")).sendKeys("9");
    driver.findElement(By.name("homepage")).click();
    driver.findElement(By.name("homepage")).clear();
    driver.findElement(By.name("homepage")).sendKeys("10");
    driver.findElement(By.name("ayear")).click();
    driver.findElement(By.name("ayear")).clear();
    driver.findElement(By.name("ayear")).sendKeys("1991");
    ...
    new Select(driver.findElement(By.name("aday"))).selectByVisibleText("-");
    driver.findElement(By.xpath("//div[@id='content']/form/select[3]/option[2]")).click();
    driver.findElement(By.name("aday")).click();
    ...
    driver.findElement(By.xpath("//div[@id='content']/form/select[5]/option[13]")).click();
    driver.findElement(By.name("address2")).click();
    driver.findElement(By.name("address2")).click();
    driver.findElement(By.name("address2")).clear();
    driver.findElement(By.name("address2")).sendKeys("1");
